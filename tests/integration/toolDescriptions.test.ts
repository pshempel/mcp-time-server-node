...
describe('Tool Descriptions Integration', () => {
  it('should return tool descriptions with system timezone as default', async () => {
    ...
    try {
      ...
      const getCurrentTimeTool = tools.find((t: Tool) => t.name === 'get_current_time');
      ...
      const addTimeTool = tools.find((t: Tool) => t.name === 'add_time');
      ...
      const subtractTimeTool = tools.find((t: Tool) => t.name === 'subtract_time');
      ...
      const calculateDurationTool = tools.find((t: Tool) => t.name === 'calculate_duration');
      ...
      const getBusinessDaysTool = tools.find((t: Tool) => t.name === 'get_business_days');
      ...
      const nextOccurrenceTool = tools.find((t: Tool) => t.name === 'next_occurrence');
      ...
      const formatTimeTool = tools.find((t: Tool) => t.name === 'format_time');
      ...
      const convertTimezoneTool = tools.find((t: Tool) => t.name === 'convert_timezone');
      ...
      const daysUntilTool = tools.find((t: Tool) => t.name === 'days_until');
